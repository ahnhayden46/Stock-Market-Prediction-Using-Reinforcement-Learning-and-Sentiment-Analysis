...
from graph import StockTradingGraph
...
class StockTradingEnv(gym.Env):
    ...
    # Adjust the prices with the adjust ratio
    ...
    # Perform a chosen action on the current state
    ...
    # Take an action and return the following rewards and next state
